...
const success_message = `🎉 You have been added to the list! Check your email to confirm your interest.`

export default async function convertkitSubscribeHandler(req: any, res: any) {
